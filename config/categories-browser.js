...
(function() {
    ...
    // Make categories globally available (only if not already defined)
    if (typeof window !== 'undefined' && !window.categories) {
        window.categories = categoriesConfig;
    }

    // For Node.js compatibility (only if not already defined)
